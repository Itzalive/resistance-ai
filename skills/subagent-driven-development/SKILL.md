...
You: "User level (~/.config/resistance/hooks/)"
...
- **resistance-engine:test-driven-development** - Subagents follow TDD for each task

**Alternative workflow:**
- **resistance-engine:executing-plans** - Use for parallel session instead of same-session execution
